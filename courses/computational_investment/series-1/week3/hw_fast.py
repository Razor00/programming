...
def get_normalized_price(dt_start, dt_end, ls_symbols):
...
def get_data(norm_price, allocation):

    print allocation
    # We need closing prices so the timestamp should be hours=16.
        # Copy the normalized prices to a new ndarry to find returns.
    na_rets = (norm_price.copy()* allocation)
...
def simulate(normalized_price):
    ...
    while n <= 9999:
        ...
        daily_ret, sharpe, cum_ret = get_data(normalized_price, allocation)
...
# question 1
    ...
    normalized_price = get_normalized_price(dt_start, dt_end, ls_symbols) 
    vol = simulate(normalized_price)

    daily_ret, sharpe, cum_ret = get_data(normalized_price, vol)
...
#    normalized_price = get_normalized_price(dt_start, dt_end, ls_symbols) 
#    vol = [0.0, 0.0, 0.1, 0.9]
#    daily_ret, sharpe, cum_ret = get_data( dt_end, ls_symbols, vol)
#    print 'Allocation       :', vol
#    print 'sharpe ratio     :', sharpe
#    print 'average daily ret:', daily_ret
#    print 'cumulative return:', cum_ret
