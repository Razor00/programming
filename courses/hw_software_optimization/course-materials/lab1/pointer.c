...
#if 0
  int dist =  (void *)ptr1 - (void *)ptr2;
  int sign = (dist >> 31) & 0x1; 
 
  dist = (((!sign << 31)>>31) & dist) + (((sign << 31) >> 31) & -dist);
  printf("%d\n", dist);
  return !(dist & 0x40);
#endif
  int *ptr3 = (void *)((((((void *)ptr1)-(void *)0) >> 6))<<6);
  int *ptr4 = (void *)((((((void *)ptr1 + 64)-(void *)0) >> 6)) << 6); 

  printf("%p %p\n", ptr3, ptr4);
  int dist1 = (void *)ptr4 - (void *)ptr2; 
  int dist2 = (void *)ptr2 - (void *)ptr3;
  printf("%d %d\n", dist1, dist2);
  int sign1 = (dist1 >> 31) & 0x1; 
  int sign2 = (dist2 >> 31) & 0x1; 
  return !(sign1 | sign2);
}
...
int withinArray(int * intArray, int size, int * ptr) {
  // TODO
  int dist1 = (void *)ptr  - (void *)(intArray); 
  int dist2 = (void *)(intArray + size - 1) - (void *) ptr;
  int sign1 = (dist1 >> 31) & 0x1; 
  int sign2 = (dist2 >> 31) & 0x1; 
  return !(sign1 | sign2);
}
