...
delta_2 = (temp_th2' * delta_3) .* sigmoidGradient(z2); 
% 5000 * 25
...
% do not remove anything from above
% but do remove the first column of theta from below

temp_th1 = Theta1;
temp_th2 = Theta2;
temp_th1(:, 1) = 0;
temp_th2(:, 1) = 0;
Theta1_grad = Theta1_grad + (lambda * temp_th1)/m;
Theta2_grad = Theta2_grad + (lambda * temp_th2)/m;
